...
tiles = {
    ...
    STAIRS_DOWN: Tile("down staircase", ('>', Pair.Red), ('>', Pair.Normal), exit_point=GameConf.PASSAGE_DOWN),
    STAIRS_UP: Tile("up staircase", ('<', Pair.Red), ('<', Pair.Normal), exit_point=GameConf.PASSAGE_UP),
